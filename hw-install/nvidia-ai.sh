...
systemctl stop gdm gdm3 lightdm || handle_error
...
cp /etc/default/grub.d/nvidia-modeset.cfg /etc/default/grub.d/nvidia-modeset.cfg.$(date +%Y%m%d%H%M%S) || handle_error
