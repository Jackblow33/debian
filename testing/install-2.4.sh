    ...
    for choice in "${selected_choices[@]}"; do
        case $choice in
            ...
            2)
                ...
                source "/home/$USR/debian/testing/hw-install/nvidia-11.4.sh"
                ;;
            3)
                echo "Installing WiFi BCM4360..."
                source "/home/$USR/debian/testing/hw-install/wifi-bcm43xx.sh"
                ;;
            4)
                echo "Installing custom kernel $KERNEL from USB..."
                source "/home/$USR/debian/testing/kernel-install.sh"
                ;;
            5)
                echo "Installing Gnome..."
                source "/home/$USR/debian/testing/gnome.sh"
                ;;
           
            6)
                echo "Installing qenu-kvm..."
                source "/home/$USR/debian/testing/qemu-kvm-0.5.sh"
                ;;
